...
sys.path.append('/ocean/vvalenzuela/MOAD/analysis-vicente/Ocean_Parcels/Kernels') #Add directory where OP_Kernels_V3 is located.
from PBDEs_OP_Kernels_V4 import * # change between files before running! Just to make sure that you are using the right Kernels :D
...
def filename_set(start,length,varlist=['U','V','W'],local=0):
   ...
   #
    ...
    variables = {'U': 'vozocrtx', 'V': 'vomecrty','W': 'vovecrtz','T':'votemper','S':'vosaline','R':'sigma_theta',
        ...
        'DIATO' : 'diatoms', 'FLAGE' : 'flagellates', 'DON' : 'dissolved_organic_nitrogen', 'cell_size' : 'e3t', 'last_cell_index' : 'mbathy', 'tmask' : 'tmask', 
        'umask': 'umask', 'vmask': 'vmask', 'fmask': 'fmask'}
