...
sys.path.append('/ocean/vvalenzuela/MOAD/analysis-vicente/Ocean_Parcels/SHARED') #Add directory where OP_Kernels is located.
from PBDEs_OP_Kernels_shared import * # change between files before running! Just to make sure that you are using the right Kernels :D
