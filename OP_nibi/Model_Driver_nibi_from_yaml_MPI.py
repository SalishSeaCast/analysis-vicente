...
import mpi4py
#
from parcels import Field, FieldSet, ParticleSet, Variable, JITParticle, mpi
...
def PBDEs_OP_run(year , month, day, sim_length, number_outputs, string,
    ...
    pset_states.execute(KE, runtime=duration, dt=delta_t, output_file=output_file, mpi=True)
