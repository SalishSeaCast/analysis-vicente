...
def filename_set(start,length,varlist=['U','V','W'],local=0):
   ...
   #
    ...
    filenames = {
        ...
        'last_cell_index' : {'lon': paths['coords'], 'lat': paths['coords'], 'data': paths['mask']},
    ...
    variables = {'U': 'vozocrtx', 'V': 'vomecrty','W': 'vovecrtz','T':'votemper','S':'vosaline','R':'sigma_theta',
        'Bathy':'Bathymetry','Kz':'vert_eddy_diff', 'ssh':'sossheig','totdepth':'totaldepth','Vol':'volume',
        'cell_size' : 'e3t', 'last_cell_index' : 'mbathy','tmask' : 'tmask', 'umask': 'umask', 'vmask': 'vmask', 'fmask': 'fmask'}
