...
INPUT_DIR = SIMULATION_BASE / 'RESTARTS' / 'R_2015'
OUTPUT_RESTART_DIR = SIMULATION_BASE / 'RESTARTS' / 'R_2016'

FILE_PREFIX = 'Tau_0_001_Ads_0_01_MC_0_2_Vel_Hx1_2_V4_2015' 
...
def process_simulations():
    ...
    for i in range(1, 13):
        ...
        restart_name = f"RESTART_2015_2016_P{i}.zarr"
