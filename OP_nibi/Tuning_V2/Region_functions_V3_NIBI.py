...
#
# Southern Strait Subregion North (smaller)
polygon_lon_lat_S1 = [
    (S1_lon_1[0], S1_lat_1[0]),
    (S1_lon_1[1], S1_lat_1[1]),
    #(S1_lon_2[1], S1_lat_2[1]),
...
def volume_region(polygon):
    volume = xr.open_dataset(path['mask'])['volume']
...
#
#
def volume_region_50m_150m(polygon):
    # Load
    mesh = xr.open_dataset(path['mask'])
    volume = mesh['volume']
    mask = xr.open_dataset(path['mask'])['tmask'][0]
...
#
def volumes_50m_bottom():
    regions_volumes = [volume_region_50m_bottom(polygon_N1), volume_region_50m_bottom(polygon_N2), volume_region_50m_bottom(polygon_N3),
                       volume_region_50m_bottom(polygon_C1), volume_region_50m_bottom(polygon_S1), volume_region_50m_bottom(polygon_SP), 
                       volume_region_50m_bottom(polygon_HW1), volume_region_50m_bottom(polygon_F1), volume_region_50m_bottom(polygon_S2),
                       volume_region_50m_bottom(polygon_H1), volume_region_50m_bottom(polygon_J1)]
    regions_string = ['N1', 'N2', 'N3', 'C1', 'S1', 'SP', 'HW1', 'F1', 'S2', 'H1', 'J1']
    return regions_volumes, regions_string
#
def volumes_50m_150m():
    regions_volumes = [volume_region_50m_150m(polygon_N1), volume_region_50m_150m(polygon_N2), volume_region_50m_150m(polygon_N3),
                       volume_region_50m_150m(polygon_C1), volume_region_50m_150m(polygon_S1), volume_region_50m_150m(polygon_SP), 
                       volume_region_50m_150m(polygon_HW1), volume_region_50m_150m(polygon_F1), volume_region_50m_150m(polygon_S2),
                       volume_region_50m_150m(polygon_H1), volume_region_50m_150m(polygon_J1)]
    regions_string = ['N1', 'N2', 'N3', 'C1', 'S1', 'SP', 'HW1', 'F1', 'S2', 'H1', 'J1']
    return regions_volumes, regions_string
#
#
#
def volume_by_depth_all_regions(polygon_dict, grid_path=path['mask'],
