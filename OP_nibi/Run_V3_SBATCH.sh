...
CONFIG_P1=$WORKDIR/config_files_V3/config_file_V3_P1.yaml
CONFIG_P2=$WORKDIR/config_files_V3/config_file_V3_P2.yaml
CONFIG_P3=$WORKDIR/config_files_V3/config_file_V3_P3.yaml
CONFIG_P4=$WORKDIR/config_files_V3/config_file_V3_P4.yaml
CONFIG_P5=$WORKDIR/config_files_V3/config_file_V3_P5.yaml
CONFIG_P6=$WORKDIR/config_files_V3/config_file_V3_P6.yaml
CONFIG_P7=$WORKDIR/config_files_V3/config_file_V3_P7.yaml
CONFIG_P8=$WORKDIR/config_files_V3/config_file_V3_P8.yaml
CONFIG_P9=$WORKDIR/config_files_V3/config_file_V3_P9.yaml
CONFIG_P10=$WORKDIR/config_files_V3/config_file_V3_P10.yaml
CONFIG_P11=$WORKDIR/config_files_V3/config_file_V3_P11.yaml
CONFIG_P12=$WORKDIR/config_files_V3/config_file_V3_P12.yaml
#
...
#python -m "$DRIVER" "$CONFIG_P6" &> "$out_txt_path/output_V3_P6.txt" &
#python -m "$DRIVER" "$CONFIG_P7" &> "$out_txt_path/output_V3_P7.txt" &
